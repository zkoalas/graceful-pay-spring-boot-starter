package com.github.zkoalas.pay.constants;

public interface AliLets {
     ...
     */
    String ALI_GATEWAY_OPEN     = "https://openapi.alipay.com/";
     ...
     * 支付宝消息验证地址
     */
    String ALI_VERIFY_URL = "https://mapi.alipay.com/gateway.do?service=notify_verify&";

    /**
     * 沙箱测试
     */
    String ALI_GATEWAY_OPEN_DEV     = "https://openapi.alipaydev.com/";
     ...
     * 接口名称   method参数
     */
    String ALI_TRADE_PAGE_PAY = "alipay.trade.page.pay";

    /**
     * 支付宝wap支付接口名称   method参数
     */
    String ALI_TRADE_WAP_PAY = "alipay.trade.wap.pay";
