...
import com.github.zkoalas.pay.utils.StreamUtil;
...
public class AliPaySignature {
    ...
    public static String sign(Map<String, String> params, String privateKey) {
        ...
        if(AliLets.SIGN_TYPE_RSA.equals(signType)) {
            return rsaSign(signContent,privateKey);
        } else if (AliLets.SIGN_TYPE_RSA2.equals(signType)) {
    ...
    public static String rsaSign(String content, String privateKey) {
        try {
            PrivateKey priKey = getPrivateKeyFromPKCS8(AliLets.SIGN_TYPE_RSA,
                    new ByteArrayInputStream(privateKey.getBytes()));

            Signature signature = Signature
                    .getInstance(AliLets.SIGN_ALGORITHMS);

            signature.initSign(priKey);
            signature.update(content.getBytes(AliLets.CHARSET_UTF8));
    ...
    public static String rsa256Sign(String content, String privateKey)  {
        ...
        try {
            ...
            Signature signature = Signature
                    .getInstance(AliLets.SIGN_SHA256RSA_ALGORITHMS);
    ...
    public static Boolean verify(Map<String, String> params, String publicKey) {
        return rsaCheckV1(params,publicKey,"UTF-8",AliLets.SIGN_TYPE_RSA2);
    }
